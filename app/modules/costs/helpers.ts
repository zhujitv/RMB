...
export function costItemFromRow(cost?: CostRow | null): CostItemForm {
  ...
  return {
    ...
    exchangeRateSource: cost.exchangeRateSource || ((cost.currency || "CNY").toUpperCase() === "CNY" ? "系统" : ""),
    exchangeRateType: cost.exchangeRateType || ((cost.currency || "CNY").toUpperCase() === "CNY" ? "人民币" : ""),
