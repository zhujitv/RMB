...
const SECTIONS: ManualSection[] = [
  ...
  },
  {
    ...
    steps: ["填写运输方式、起运地、到达地、运输货物名称、起运日期、车牌号或快递单号。", "系统生成出口发票备注。", "上传报关单、放行通知书、报关委托书。", "报关单 PDF 上传成功后，系统自动识别报关单号和申报日期，并同步到退税资料。"],
  ...
  },
  {
    ...
    notes: ["列表只保留总体完整度，分类明细在详情弹窗中处理。", "出口资料和报关资料使用统一卡片格式，每个资料类型只显示一个当前有效 PDF。", "未上传时显示上传PDF文件，已上传时显示替换当前PDF。", "删除报关单会同步清空报关单号和申报日期。", "总体完整度不足 100% 不允许提交退税。"],
    entry: "退税资料",
  },
  {
    id: "archive",
