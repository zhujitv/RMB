...
const SECTIONS: ManualSection[] = [
  ...
  },
  {
    ...
    notes: ["管理员、业务员、物流供应商和物流资料录入员可查看系统内所有已创建的大掌櫃海运跟踪；产品供应商不可见。", "运输监控默认只显示未到港 / 未完成的在途业务，已到港或已完成记录可通过筛选查看。", "一张 Master B/L 在系统生命周期内只创建一次大掌櫃 Tracking；柜号只用于本地关联查询，避免重复消耗 Credit。", "后台页面优先显示中文船公司、港口、状态和跟踪方式，原始英文数据仍保留在系统中。"],
    entry: "物流信息 → 运输监控",
  },
  {
    id: "tax-refunds",
