...
const SECTIONS: ManualSection[] = [
  ...
  },
  {
    ...
    no: "05",
    title: "成本管理",
    summary: "成本管理用于记录每票订单产生的工厂货款、拖车费、报关费、港杂费、打单费、ENS费、进港费、提箱费、落箱费、预提费、海运费、手续费、佣金和其它费用。",
  ...
  },
  {
    ...
    steps: ["选择车辆运输、快递运输、多式联运或散货进舱，并填写对应运输/进舱信息。", "系统生成退税资料所需运输备注。", "上传报关单、放行通知书、报关委托书。", "报关单 PDF 上传成功后，系统自动识别报关单号和申报日期，并同步到退税资料。"],
