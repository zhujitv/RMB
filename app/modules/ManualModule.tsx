...
const SECTIONS: ManualSection[] = [
  ...
  },
  {
    ...
    no: "06",
    title: "物流信息",
    summary: "物流信息是物流模块唯一入口，集中维护物流状态、首程运输事实数据、报关资料、物流费用录入与审核。",
  ...
  },
  {
    ...
    steps: ["在公司资料中维护品牌名称、系统名称、中英文公司名称和联系方式。", "维护客户资料和负责业务员。", "按供应商类型配置产品供应商资料回传权限，以及物流供应商费用录入、发票上传和费用类型权限。", "维护物流费用开票通知模板、抄送邮箱和公司品牌配置。", "维护用户角色、权限和账号状态。", "查看操作日志追溯关键修改。"],
    notes: ["公司资料会影响登录页品牌、工作台侧边栏、首页欢迎语、Logo 和页脚版权等系统展示。", "汇率影响所有外币折人民币金额。", "客户资料中的业务员和提成比例会影响利润与提成统计。", "用户权限决定能看到哪些模块。", "产品供应商账号只用于资料回传；物流类供应商账号用于物流资料、费用和发票相关操作。"],
    entry: "系统设置",
  },
  {
    id: "security",
