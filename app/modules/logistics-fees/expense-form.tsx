...
export function LogisticsExpenseForm({
  ...
  return (
    <LogisticsExpenseFormView
      ...
      isLockedSupplier={isLockedSupplier}
      supplierSummaryText={supplierSummaryText}
      supplierAllowedCostTypes={supplierAllowedCostTypes}
      costTypeOptions={costTypeOptions}
      formCurrencySummary={formCurrencySummary}
      searchOrders={searchOrders}
      searchSuppliers={searchSuppliers}
      onOrderSelect={handleOrderSelect}
      onSupplierSelect={handleSupplierSelect}
      onItemCostTypeChange={handleItemCostTypeChange}
      onItemCurrencyChange={handleItemCurrencyChange}
