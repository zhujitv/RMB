      ...
      const result = await apiJson<{ success?: boolean; message?: string; entity?: BusinessEntityRow }>(
        "/api/settings/business-entities",
        {
          ...
          body: JSON.stringify({
            ...
            nameEn: businessEntityForm.nameEn, taxNumber: businessEntityForm.taxNumber,
            domesticBankName: businessEntityForm.domesticBankName, domesticBankAccount: businessEntityForm.domesticBankAccount,
