...
export function emptySupplierForm(): SupplierForm {
  return {
    ...
    bankAccount: "",
    purchasePaymentTerm: "",
    purchasePrepaymentPercent: "0",
    purchaseQuantityTolerancePercent: "5",
    purchasePrepaymentRequiredBeforeProduction: false,
...
export function emptyBusinessEntityForm(): BusinessEntityForm {
  return {
    ...
    contactPhone: "",
    website: "",
    showContactPhoneOnPi: false,
    showContactEmailOnPi: false,
    showWebsiteOnPi: false,
    bankAccounts: {
      CNY: { currency: "CNY", beneficiaryName: "", beneficiaryAddress: "", bankName: "", accountNumber: "", swiftCode: "" },
      USD: { currency: "USD", beneficiaryName: "", beneficiaryAddress: "", bankName: "", accountNumber: "", swiftCode: "" },
    },
    isDefault: false,
    status: "启用",
    sortOrder: "0",
...
export function businessEntityFormFromRow(entity: BusinessEntityRow): BusinessEntityForm {
  const empty = emptyBusinessEntityForm();
  return {
    id: entity.id || "",
    name: entity.name || "",
    ...
    bankAccounts: {
      CNY: { ...empty.bankAccounts.CNY, ...entity.bankAccounts?.CNY, currency: "CNY" },
      USD: { ...empty.bankAccounts.USD, ...entity.bankAccounts?.USD, currency: "USD" },
    },
...
export function supplierFormFromRow(supplier: SupplierRow): SupplierForm {
  return {
    ...
    purchasePrepaymentPercent: supplier.purchasePrepaymentPercent || "0",
    purchaseQuantityTolerancePercent: supplier.purchaseQuantityTolerancePercent || "5",
