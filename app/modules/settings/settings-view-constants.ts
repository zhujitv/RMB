...
export const SETTINGS_HOME_CARDS: Array<{ tab: SettingsTabKey; title: string; description: string; icon: string }> = [
  ...
  { tab: "customerProducts", title: "客户产品库", description: "按客户维护物料编码、产品属性、单位和价格", icon: "品" },
  ...
  { tab: "smsIntegration", title: "短信通知", description: "腾讯云采购通知短信", icon: "信" },
  { tab: "crmEmailIntegration", title: "CRM邮件", description: "客户邮件账户、收发开关和系统邮箱域名", icon: "邮" },
...
export const SETTINGS_PAGE_DESCRIPTIONS: Record<SettingsTabKey, string> = {
  ...
  customerProducts: "选择客户后维护报价和销售共用的物料编码、产品属性、单位及最近价格。",
  suppliers: "维护产品供应商、物流供应商和业务权限。",
  users: "维护用户账号、角色权限和供应商绑定。",
  ocrIntegration: "维护 OCR 服务配置、密钥和启用范围。",
  shipsgoIntegration: "维护海运跟踪接口和同步能力。",
  smsIntegration: "维护腾讯云短信凭据、签名和订单下发模板。",
  crmEmailIntegration: "维护 CRM 邮件模块开关、系统邮箱域名和收发通道。",
