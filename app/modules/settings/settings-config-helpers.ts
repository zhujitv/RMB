...
export function shipsgoIntegrationFormFromSettings(settings: ShipsgoIntegrationSettings | null): ShipsgoIntegrationForm {
  return {
    ...
    freightowerDefaultLang: stringSetting(settings, "freightowerDefaultLang", DEFAULT_SHIPSGO_INTEGRATION_FORM.freightowerDefaultLang),
    freightowerHiddenReference: settings?.freightowerHiddenReference === true,
    oceanTrackingEnabled: settings?.oceanTrackingEnabled !== false,
    customsTrackingEnabled: settings?.customsTrackingEnabled === true,
...
export function ocrIntegrationFormFromSettings(settings: OcrIntegrationSettings | null): OcrIntegrationForm {
  return {
    ...
    tencentSecretId: "",
    tencentSecretIdConfigured: settings?.tencentSecretIdConfigured === true,
    tencentSecretKey: "",
    tencentSecretKeyConfigured: settings?.tencentSecretKeyConfigured === true,
