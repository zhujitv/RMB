import { apiError, canRead, getActor, getOverview, listCustomers, listOrders, listPayments, listSuppliers, listUsers, ok } from "../../../lib/platform-db";
...
export async function GET(request) {
  try {
    ...
    const [overview, orders, payments, customers, suppliers, users] = await Promise.all([
