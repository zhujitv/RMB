...
function cosBrowserSources(env = process.env) {
  const region = String(env.COS_REGION || env.TENCENT_COS_REGION || "").trim();
  if (!/^[a-z0-9-]+$/.test(region)) return [];
  return [
