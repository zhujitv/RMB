...
export const LOGISTICS_COST_TYPES = ["国内物流费", "国内拖车费", "报关费", "港杂费", "文件费", "订舱费", "海运费", "目的港费用", "保险费", "其他物流费用"];
...
function emptyTaxRefundCompleteness() {
  ...
  return {
    complete: false,
    total: TAX_EXPORT_DOCUMENT_TYPES.length + supplierTotal + TAX_REFUND_LOGISTICS_INVOICE_REQUIREMENTS.length,
    completed: 0,
    missingTypes: [],
    missingLabels: [],
