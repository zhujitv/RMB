...
export const ROLE_SCOPE_TEXT = {
  ...
  [LEGACY_LOGISTICS_OPERATOR_ROLE]: "可录入物流信息和报关资料",
  查看者: "只读权限",
};
...
async function backfillMissingAvatarInitials() {
