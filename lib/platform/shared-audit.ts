...
export const SENSITIVE_AUDIT_KEY_PATTERN = /(password|passwordHash|token|secret|accessKey|authorization|cookie|session|storageKey|r2Key|r2Bucket|fileUrl|avatarUrl|originalName|originalFilename)/i;
