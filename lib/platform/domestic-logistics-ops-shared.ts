  ...
  if (includeShipsgoTrackings) {
    include.shipsgoTrackings = {
      ...
      select: {
        ...
        rawPayload: true,
        rawResponse: true,
        portTrackingStatus: true,
        portTrackingMessage: true,
        portCode: true,
        portDirection: true,
        portLastCheckedAt: true,
        portLastSyncedAt: true,
        portRawResponse: true,
        customsTrackingStatus: true,
        customsTrackingMessage: true,
        customsDirection: true,
        customsLastCheckedAt: true,
        customsLastSyncedAt: true,
        customsRawResponse: true,
        containers: {
