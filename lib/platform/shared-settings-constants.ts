...
export const DEFAULT_SHIPSGO_INTEGRATION_SETTINGS = {
  ...
  freightowerWebhookCallbackUrl: "https://www.nextwood.net/api/freightower/webhook",
...
export const LOGISTICS_INVOICE_SUPPLIER_EMAIL_FIELD_OPTIONS = [
  ...
  { value: "email", label: "供应商联系人邮箱", field: "supplier.email" },
];
export const DEFAULT_LOGISTICS_INVOICE_SUPPLIER_EMAIL_FIELDS = ["email"];
export const DEFAULT_LOGISTICS_INVOICE_NOTIFICATION_SETTINGS = {
  ...
  ccAdminEmails: false,
  ccEmails: [],
  singleSubjectTemplate: "物流费用审核通过，请上传发票 - {orderNo}/{blNo}",
