...
function amountText(value: unknown) {
  ...
  if (!text) return "0.00";
  try {
    return new Prisma.Decimal(text).toFixed(2);
  } catch {
    return text;
  }
}
...
function chineseCurrency(value: string) {
  ...
  const [integerRaw, decimalRaw = ""] = amountText(value).split(".");
...
function worksheet(draft: SupplierTaxContractDraft) {
  ...
  for (const item of draft.items) {
    ...
    rows.push(`<row r="${row}" ht="20" customHeight="1">${inlineCell(row, 1, item.productName, 8)}${numberCell(row, 2, quantity, quantityStyle)}${inlineCell(row, 3, item.unit, 8)}${numberCell(row, 4, item.unitPriceWithTax)}${numberCell(row, 5, amountText(item.amountWithTax), 13)}${inlineCell(row, 6, draft.latestDeliveryDate, 6)}</row>`);
    row += 1;
  }
  const totalRow = row;
  rows.push(`<row r="${row}" ht="15" customHeight="1">${inlineCell(row, 1, "合计", 7)}${numberCell(row, 5, amountText(draft.totalAmountWithTax), 5)}${inlineCell(row, 6, "", 6)}</row>`);
  row += 1;
...
export async function generateSupplierTaxContractXlsx(draft: SupplierTaxContractDraft) {
  ...
  zip.folder("xl")?.file("styles.xml", `${XML_HEADER}<styleSheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><numFmts count="2"><numFmt numFmtId="164" formatCode="0.######"/><numFmt numFmtId="165" formatCode="0.00"/></numFmts><fonts count="4"><font><sz val="11"/><name val="宋体"/></font><font><b/><sz val="16"/><name val="宋体"/></font><font><b/><sz val="11"/><name val="宋体"/></font><font><sz val="12"/><name val="宋体"/></font></fonts><fills count="2"><fill><patternFill patternType="none"/></fill><fill><patternFill patternType="gray125"/></fill></fills><borders count="2"><border/><border><left style="thin"/><right style="thin"/><top style="thin"/><bottom style="thin"/></border></borders><cellStyleXfs count="1"><xf fontId="0" fillId="0" borderId="0"/></cellStyleXfs><cellXfs count="14"><xf fontId="0" fillId="0" borderId="0"/><xf fontId="0" fillId="0" borderId="0" applyAlignment="1"><alignment vertical="center" wrapText="1"/></xf><xf fontId="1" fillId="0" borderId="0" applyAlignment="1"><alignment horizontal="center" vertical="center"/></xf><xf fontId="2" fillId="0" borderId="1" applyAlignment="1"><alignment horizontal="center" vertical="center"/></xf><xf fontId="0" fillId="0" borderId="1" numFmtId="164" applyNumberFormat="1" applyAlignment="1"><alignment horizontal="center" vertical="center"/></xf><xf fontId="2" fillId="0" borderId="1" numFmtId="165" applyNumberFormat="1"/><xf fontId="0" fillId="0" borderId="1" applyAlignment="1"><alignment vertical="center" wrapText="1"/></xf><xf fontId="2" fillId="0" borderId="1" applyAlignment="1"><alignment horizontal="center" vertical="center"/></xf><xf fontId="0" fillId="0" borderId="1" applyAlignment="1"><alignment horizontal="center" vertical="center" wrapText="1"/></xf><xf fontId="0" fillId="0" borderId="0" applyAlignment="1"><alignment vertical="center" wrapText="1"/></xf><xf fontId="3" fillId="0" borderId="0" applyAlignment="1"><alignment vertical="center" wrapText="1"/></xf><xf fontId="0" fillId="0" borderId="1" numFmtId="165" applyNumberFormat="1" applyAlignment="1"><alignment horizontal="center" vertical="center"/></xf><xf fontId="0" fillId="0" borderId="1" numFmtId="1" applyNumberFormat="1" applyAlignment="1"><alignment horizontal="center" vertical="center"/></xf><xf fontId="0" fillId="0" borderId="1" numFmtId="165" applyNumberFormat="1" applyAlignment="1"><alignment horizontal="center" vertical="center"/></xf></cellXfs><cellStyles count="1"><cellStyle name="常规" xfId="0" builtinId="0"/></cellStyles></styleSheet>`);
