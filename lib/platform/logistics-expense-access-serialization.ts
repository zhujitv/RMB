...
export function includeLogisticsExpenseRelations() {
  return Prisma.validator<Prisma.LogisticsExpenseInclude>()({
    ...
    customsDeclaration: { select: { id: true, batchNo: true, declarationNo: true, declarationDate: true, declarationAmount: true, containerCount: true } },
...
export function serializeLogisticsExpense(expense: LogisticsExpenseLike = {}) {
  ...
  return {
    ...
    customsDeclarationNo: expense.customsDeclaration?.declarationNo || "",
    customsDeclarationBatchNo: expense.customsDeclaration?.batchNo || "",
    customsDeclarationDate: dateToInput(dateFromInput(expense.customsDeclaration?.declarationDate)),
    customsDeclarationAmount: expense.customsDeclaration?.declarationAmount == null ? null : Number(expense.customsDeclaration.declarationAmount || 0),
    customsDeclarationContainerCount: expense.customsDeclaration?.containerCount == null ? null : Number(expense.customsDeclaration.containerCount || 0),
    allocationMethod: expense.allocationMethod || "",
    allocatedAmount: expense.allocatedAmount == null ? null : Number(expense.allocatedAmount || 0),
